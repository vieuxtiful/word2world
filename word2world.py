...
- Images: OpenAI CLIP (Contrastive Language–Image Pretraining) generates aligned 512-dimensional image-text embeddings, supporting rich cross-modal semantic associations.
...
f(⋅) is a scoring function calibrated for optimal bridge discovery, empirically in the [0.3, 0.5] range.
...
# Celery Tasks
# ============================================================================
# Celery tasks for nightly re-weighting are in celery_tasks.py
# See CELERY_DEPLOYMENT.md for deployment instructions
...
# Robust covariance estimation
from robust_covariance import CovarianceEstimator, CovarianceConfig
...
# ============================================================================
# Align2World: Multi-Modal Mahalanobis Distance (High-Dimensional Space)
# ============================================================================
...
class Align2World:
    ...
    def fit(self, X_multimodal: np.ndarray):
        ...
        # Fit robust covariance estimator
        self.estimator = CovarianceEstimator(cov_config)
...
# ============================================================================
# Flow2World: Hyperbolic Geometry (Low-Dimensional Space)
# ============================================================================
