...
class Node2VecABTest:
    ...
    def generate_report(self) -> str:
        ...
        if self.results.confidence > 0.7:
            report.append(f"✅ STRONG EVIDENCE: Deploy {self.results.winning_arm} configuration")
        elif self.results.confidence > 0.5:
            report.append(f"📊 MODERATE EVIDENCE: Consider {self.results.winning_arm} configuration")
        else:
            report.append("🔍 INCONCLUSIVE: Continue experimentation or refine configurations")
